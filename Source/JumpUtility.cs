...
namespace HellBionics
{
    public static class JumpUtility
    {
        public static bool DoJump(Pawn pawn, LocalTargetInfo currentTarget, CompReloadable comp, VerbProperties verbProps)
		{
			...
			PawnFlyer pawnFlyer = PawnFlyer.MakeFlyer(HellBionics.ThingDefOf.PawnJumper, pawn, cell, verbProps.flightEffecterDef, verbProps.soundLanding, verbProps.flyWithCarriedThing);
			if (pawnFlyer != null)
			{
